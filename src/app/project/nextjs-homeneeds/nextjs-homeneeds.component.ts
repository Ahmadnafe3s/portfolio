...
export class NextjsHomeNeedsComponent {
    ...
    keyFeatures = [
        ...
        { Name: 'Email verification', featureDescription: 'Appication has feture for Email verification while during SignUp process . Application sends an OTP to that email which user is trying to sign up.' },
        ...
        {Name : 'Dynamic Form' , featureDescription : 'Application has a dynamic form for posting recipes which has lots of different fileds.'},

        { Name: 'Forget Password', featureDescription: 'In case if user gets forget their password, the user has option to reset their password by following simple steps.' },
        ...
        { Name: 'Profile', featureDescription: 'Authenticated user can see their own and other users profile and their posts . In the profile section authenticated user can manage their own posts Such as they can perform CRUD operations ,  User can Deactivate their account and can change their Account password.' },
